...
const Menu = ({ pageRef }) => {
  ...
  const menuItems = [
    ...
    { label: "Studio", route: "/studio", disabled: true },
    { label: "Stories", route: "/stories", disabled: true },
    ...
    <>
      ...
      <div className="menu-overlay" ref={menuOverlayRef}>
        <div className="menu-content">
          ...
          >
            ...
            <div className="menu-content-group">
              <p>Say Hello</p>
              <a href="mailto:kaytechventures@gmail.com">kaytechventures@gmail.com</a>
            </div>
          </div>
          <div
            className="menu-col"
          ...
          >
            <div className="menu-content-group">
              ...
              <a href="https://www.linkedin.com/in/kayeddy" target="_blank">
                LinkedIn
              </a>

              <a href="https://github.com/kayeddy" target="_blank">
                GitHub
              </a>

              {/* <a href="https://x.com/EduShed" target="_blank">
                X / Twitter
              </a>

              <a href="https://instagram.com/EduShed" target="_blank">
                Instagram
              </a> */}
            </div>
          </div>
        ...
        <div className="menu-img menu-img-logo">
          <img ref={menuImageRef} src="/Core/logo.svg" alt="Kydek Studio Logo" />
        </div>
        ...
        <div className="menu-links-wrapper" ref={menuLinksWrapperRef}>
          {menuItems.map((item, index) => (
            <div
              key={item.label}
              className={`menu-link${item.disabled ? " menu-link-disabled" : ""}`}
              ref={(el) => {
                menuLinkContainersRef.current[index] = el;
              }}
              onClick={(e) => {
                e.preventDefault();
                // Ignore clicks while menu is animating
                if (isMenuAnimating) return;

                // Show coming soon popup for disabled items
                if (item.disabled) {
                ...
                // Close menu first, then navigate after animation starts
                if (isMenuOpen) {
                  toggleMenu();
                  // Delay navigation to let menu close animation progress
                  setTimeout(() => {
      ...
      {showComingSoon && (
        <div className="coming-soon-overlay" onClick={() => setShowComingSoon(false)}>
          <div className="coming-soon-dialog" onClick={(e) => e.stopPropagation()}>
            <p className="coming-soon-title">Coming Soon</p>
            <p className="coming-soon-message">Stay tuned!</p>
            <button className="coming-soon-button" onClick={() => setShowComingSoon(false)}>
              Got it
            </button>
          </div>
        </div>
