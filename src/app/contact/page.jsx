    ...
    <section className="contact screensaver-container" ref={containerRef}>
      <div className="contact-copy">
        <div className="contact-col">
          <Copy delay={0.8}>
            <h2>Got an idea? Let&apos;s make it hit.</h2>
          </Copy>
        </div>
        ...
        <div className="contact-col">
          ...
          <div className="contact-group">
            <Copy delay={1.2}>
              <p className="sm">Based In</p>
              <p>Colombia</p>
            </Copy>
          </div>

          <div className="contact-mail">
            <Button delay={1.3} href="mailto:kaytechventures@gmail.com">
              kaytechventures@gmail.com
            </Button>
          </div>
          ...
          <div className="contact-group">
            <Copy delay={1.4}>
              <p className="sm">Languages</p>
              <p>English, Spanish, Creole</p>
            </Copy>
          </div>
        </div>
      </div>
        ...
        <div className="container">
          ...
          <div className="contact-socials">
            <Copy delay={1.7} animateOnScroll={false}>
              <a
                className="sm"
                href="https://www.linkedin.com/in/kayeddy"
                target="_blank"
              >
                LinkedIn
              </a>
            ...
            <Copy delay={2.0} animateOnScroll={false}>
              <a
                className="sm"
                href="https://instagram.com/EduShed"
                target="_blank"
              >
                Instagram
              </a>
          ...
          <Copy delay={2.1} animateOnScroll={false}>
